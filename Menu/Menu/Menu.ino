...
void setup() {
  ...
  lcd.setCursor(1, 0);      lcd.print("MAY HAN CELL PIN");
  lcd.setCursor(0, 1);      lcd.print("KhacDinh-19146174");
  lcd.setCursor(0, 2);      lcd.print("DucDuy-19146174");
  lcd.setCursor(0, 3);      lcd.print("VanThieu-19146174");
  delay(2000);
  lcd.clear();
}
void Page1(){
  lcd.setCursor(0, 3);      lcd.print("1");
}
void Page2(){
  lcd.setCursor(0, 3);      lcd.print("2");
}
void Page3(){
  lcd.setCursor(0, 3);      lcd.print("3");
}
void loop() {
  if(digitalRead(KHOP_Z) == 0) {
    delay(50);
